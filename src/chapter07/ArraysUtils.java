    ...
    */
    ...
    public static boolean isAnagram2(String s1, String s2) {
        ...
        for (int i = 0; i < s1.length(); i++) {
            ...
            counts[s1.toLowerCase().charAt(i) - 'a']++; // do not call .toLowerCase() inside a loop because it creates string objects!
    ...
    public static void main(String[] args) {
        ...
        Arrays.fill(array1, 0); // [-1, -1, -1, -1, -1]

        int[] years = {2006, 1991, 2003, 1945};
        Arrays.sort(years); // [1945, 1991, 2003, 2006]

        int[] backup = {1945, 1991, 2003, 2006};
        boolean isSame = Arrays.equals(years, backup); // true

        int[] a = {1, 2, 3};
        int[] b = {1, 2, 4};
        int result = Arrays.compare(a, b); // - 1 because 3 < 4
